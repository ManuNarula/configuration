...
theme.fs = lain.widget.fs({
    notification_preset = { fg = theme.fg_normal, bg = theme.bg_normal, font = "Terminus 11" },
    settings = function()
...
awful.spaw.with_shell("feh --bg-fill /home/manu/pictures/wallpaper/andrew-svk-O-jSLVxzoBg-unsplash.jpg")
